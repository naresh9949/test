...
export function FilterModel(props) {
  ...
  return (
    <div>
      <IconButton color="primary" onClick={handleClickOpen} aria-label="filter">
...
function TableTollBar(props) {
  ...
  return (
    <Toolbar overflow="scroll">
      ...
      <ColumnPicker name={props.name} headCells={props.headCells} showedCells = {props.showedCells} setHeadCells={props.setHeadCells} />
      {/* 
      <SelectModel
